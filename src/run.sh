...
python format.py tag.tsv tag-dict.tsv
...
shadoop fs -test -e "/home/nlp/huangjingwen/data/category-title/ds=${DATE}"
if [ $? -eq 0 ]
then
    shadoop fs -rmr "/home/nlp/huangjingwen/data/category-title/ds=${DATE}"
fi
shadoop fs -mkdir "/home/nlp/huangjingwen/data/category-title/ds=${DATE}"
shadoop fs -put category-title.tsv "/home/nlp/huangjingwen/data/category-title/ds=${DATE}"
...
bash make-reverse-index.sh "${DATE}"
shadoop fs -cat "/home/nlp/huangjingwen/data/reverse-index/ds=${DATE}/part*" > reverse-index.tsv
